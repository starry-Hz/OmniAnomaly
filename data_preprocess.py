...
def load_data(dataset):
    if dataset == 'SMD':
        ...
        # file_list = ['machine-1-1.txt','machine-1-6.txt', 'machine-1-7.txt', 'machine-2-1.txt', 'machine-2-2.txt','machine-2-3.txt', 'machine-2-4.txt','machine-2-7.txt','machine-2-8.txt','machine-3-3.txt', 'machine-3-4.txt','machine-3-6.txt','machine-3-8.txt','machine-3-10.txt','machine-3-11.txt',]
        file_list = [
